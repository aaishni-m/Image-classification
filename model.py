...
base = "c:\Aaishni Study Courses\IIT Bombay courses\D-E placement courses\Data Science\3. Age and Gender Prediction using Chest X-Ray scans Project"
print("\n\n")
...
def image_pre(path):
    print(path)
    data = np.ndarray(shape=(1,128,128,1))
